	...
	_createClass(FormField, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { className: className, id: this.props.name, name: this.props.name, onBlur: this.props.handleBlur, placeholder: this.props.placeholder, type: 'number' })
			);
		}
	}]);
...
var _Debt = __webpack_require__(29);
...
var _Results = __webpack_require__(31);

var _Results2 = _interopRequireDefault(_Results);

var _ResultsData = __webpack_require__(32);
...
var Form = function (_React$Component) {
	...
	_createClass(Form, [{
		...
		value: function calculate() {
			...
			setVars();
			makePerson();
			_reactDom2.default.render(_react2.default.createElement(_Results2.default, { resultData: work() }), document.querySelector('.results-wrapper'));
			retire();
			_reactDom2.default.render(_react2.default.createElement(_Message2.default, { person: person, vars: vars }), document.querySelector('.message-wrapper'));
		}
	}, {
		key: 'render',
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_FormField2.default, { handleBlur: function handleBlur() {
					...
					}, label: 'Annual Income (Gross)', name: 'income', placeholder: '$50000' }),
				_react2.default.createElement(_FormField2.default, { handleBlur: function handleBlur() {
						return _this2.calculate();
					}, label: 'Current Age', name: 'curAge', placeholder: '25' }),
				_react2.default.createElement(_FormField2.default, { handleBlur: function handleBlur() {
						return _this2.calculate();
					}, label: 'Target Retirement Age', name: 'retAge', placeholder: '67' }),
				_react2.default.createElement(_FormField2.default, { handleBlur: function handleBlur() {
						return _this2.calculate();
					}, label: 'Current Savings', name: 'savings', placeholder: '$0' }),
				_react2.default.createElement(_FormField2.default, { handleBlur: function handleBlur() {
						return _this2.calculate();
					}, label: 'Percent of Net income saved', name: 'savePercent', placeholder: '15%' }),
				_react2.default.createElement(_FormField2.default, { handleBlur: function handleBlur() {
						return _this2.calculate();
					}, label: 'Expected average raise', name: 'raisePercent', placeholder: '5%' }),
				_react2.default.createElement(_FormField2.default, { handleBlur: function handleBlur() {
						return _this2.calculate();
					}, label: 'Target Retirement Income', name: 'retIncome', placeholder: '$200000' }),
				_react2.default.createElement(
					'label',
					null,
					'Debt'
...
_reactDom2.default.render(_react2.default.createElement(Form, null), document.querySelector('.form-wrapper'));
...
function payOffDebt(amount) {
	...
	var leftover = amount - person.debt.total;
...
function work() {
	var rows = [];
	for (var year = 1; year <= vars.workingYears; year++) {
